...
const wordList12 = wordList11.filter(s => (s.match(/o/gi) || [] ).length <= 1)
const wordList13 = wordList12.filter(s => (s.match(/s/gi) || [] ).length <= 1)
...
wordList16=[]
for(i in wordList15) {
    if (wordList15[i].length == 5 || wordList15[i].length == 8 ){
...
var expectedResult = 'e4820b45d2277f3844eac66c903e84be'
